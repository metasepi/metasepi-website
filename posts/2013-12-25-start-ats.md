...
t@ypeはviewt@ypeのサブとなる種であることに注意してください。
...
1. Import an existing C function to ATS and decorate it with an ATS type, or
2. Export an ATS-implemented function to C with that name.
